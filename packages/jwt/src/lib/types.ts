...
import type { JsonObject, MiddlewareConfig as MWConfig } from '@waiting/shared-types'
import type { DecodeOptions, JwtHeader, Secret, SignOptions, VerifyOptions } from 'jsonwebtoken'
